...
Shader "StandardSpecular_URP" {
	...
	SubShader {
		...
		// UsePass ShadowCaster or DepthOnly breaks SRP Batcher compatibility so we should define them
		...
		Pass {
			...
			// Note if we do any vertex displacement, we'll need to redefine a vertex function here. 
			ENDHLSL
		}
